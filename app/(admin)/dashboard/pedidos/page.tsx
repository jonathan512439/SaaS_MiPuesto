...
export default async function PaginaPedidos() {
  ...
  const [resultadoPedidos, agenda] = await Promise.all([
    supabase
      .from("pedidos")
      .select(
        "id,codigo,cliente_nombre,cliente_telefono,numero_mesa,total,estado,creado_en,expira_en,confirmado_en,confirmado_por,cancelado_en,cancelado_por,datos_cliente_borrados_en,pedido_items(id,producto_codigo,nombre,precio_unitario,cantidad,subtotal,controla_stock,variante_nombre,tipo_presentacion)",
      )
