...
export default async function PaginaConfiguracion() {
  ...
  const { data: negocio } = await supabase
    .from("negocios")
    .select("nombre,slug,descripcion,subnombre,tipo_negocio,telefono_whatsapp,horario,reserva_minutos,logo_url,portada_url,qr_pago_url,redes_sociales,ubicacion_url,resenas_url,ciudad,zona,rubro,pide_numero_mesa")
