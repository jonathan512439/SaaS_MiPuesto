 ...
 */
const CAMPOS =
  "id,slug,nombre,descripcion,tipo_negocio,telefono_whatsapp,horario,plantilla_id,tarjeta_id,paleta_id,logo_url,portada_url,qr_pago_url,redes_sociales,banners,ubicacion_url,pide_numero_mesa,resenas_url,rubro,patron_fondo,patron_opacidad,subnombre,activo";
