...
export const COLUMNAS_PRODUCTO_ADMIN =
  "id,codigo,categoria_id,subcategoria_id,nombre,descripcion,precio,precio_anterior,precio_actualizado_en,precio_actualizado_por,fotos,controla_stock,cantidad_stock,cantidad_reservada,visible,estado,orden,en_carta_hasta,atributos,duracion_minutos" as const;
...
export const COLUMNAS_PRODUCTO_PUBLICO =
  "id,codigo,categoria_id,subcategoria_id,nombre,descripcion,precio,fotos,controla_stock,cantidad_stock,cantidad_reservada,estado,visible,orden,en_carta_hasta,atributos,duracion_minutos" as const;
